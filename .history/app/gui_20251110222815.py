...
class FLAC2AIFFApp:
    ...
    def _run_conversion(self, input_path: Path, output_path: Path) -> None:
        ...
        try:
            ...
            import subprocess
            transcoder = self.engine.transcoder
            test_cmd = [transcoder.ffmpeg_path, "-version"]
            try:
                ...
                if result.returncode != 0 and "ffmpeg" not in transcoder.ffmpeg_path.lower():
                    # ffmpeg not found
                    error_msg = (
                        f"FFmpeg not found at: {transcoder.ffmpeg_path}\n\n"
                ...
                error_msg = (
                    f"FFmpeg not found or not accessible.\n\n"
                    f"Error: {str(e)}\n\n"
                    "Please install ffmpeg:\n"
                    "  brew install ffmpeg\n\n"
                    "Or run: ./setup_ffmpeg.sh"
