...
class FLAC2AIFFApp:
    ...
    def _build_ui(self) -> None:
        ...
        input_label.grid(row=row, column=0, sticky=tk.W, pady=15)
        ...
        input_entry.grid(row=row, column=1, sticky=(tk.W, tk.E), padx=15, pady=15, ipady=8)
        ...
        input_button.grid(row=row, column=2, padx=5, pady=15)
        row += 1
        ...
        output_label.grid(row=row, column=0, sticky=tk.W, pady=15)
        ...
        output_entry.grid(row=row, column=1, sticky=(tk.W, tk.E), padx=15, pady=15, ipady=8)
        ...
        output_button.grid(row=row, column=2, padx=5, pady=15)
        row += 1
