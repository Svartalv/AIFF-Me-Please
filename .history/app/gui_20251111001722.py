...
class FLAC2AIFFApp:
    ...
    def __init__(self, root: tk.Tk):
        ...
        # Configure dark theme colors - minimal and dark
        self.bg_color = "#000000"  # Pure black
        self.fg_color = "#ffffff"  # White text
        self.accent_color = "#1a1a1a"  # Dark gray for buttons
        self.secondary_bg = "#0a0a0a"  # Very dark for inputs
        self.border_color = "#000000"  # No visible borders
        self.hover_color = "#2a2a2a"  # Slightly lighter on hover
    ...
    def _build_ui(self) -> None:
        ...
        # Title with modern styling - minimal
        title_label = tk.Label(
            main_frame,
            text="AIFF Me Please",
            font=("SF Pro Display", 20, "normal"),  # Modern system font
            bg=self.bg_color,
            fg=self.fg_color
        )
        ...
        # Input folder - minimal design
        input_label = tk.Label(
            main_frame,
            text="Input folder:",
            font=("SF Pro Text", 11, "normal"),
            bg=self.bg_color,
            fg="#888888"  # Subtle gray text
        )
        ...
        input_entry.grid(row=row, column=1, sticky=(tk.W, tk.E), padx=15, pady=12, ipady=10)
        ...
        output_entry.grid(row=row, column=1, sticky=(tk.W, tk.E), padx=15, pady=12, ipady=10)
        ...
        # Configure treeview style for minimal dark theme
        ...
        style.configure("Treeview.Heading",
            ...
            foreground="#888888",  # Subtle gray headers
            borderwidth=0,
            relief=tk.FLAT,
        ...
        # Configure scrollbar for dark theme - minimal
        ...
        # Start button - minimal black design
    ...
    def _start_conversion(self) -> None:
        ...
        # Disable start button with visible disabled state
    ...
    def _conversion_complete(self, converted: int, failed: int, total: int) -> None:
        ...
        self.is_converting = False
        self.start_button.config(state=tk.NORMAL, bg=self.accent_color, cursor="hand2")
        
        if converted > 0:
            self.status_label.config(
                text=f"Complete! Converted {converted} of {total} file(s)",
                fg="#4ade80"  # Green for success
            )
            messagebox.showinfo(
                "Conversion Complete",
