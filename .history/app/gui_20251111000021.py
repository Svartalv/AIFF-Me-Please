...
class FLAC2AIFFApp:
    ...
    def _update_file_list(self, files: list) -> None:
        ...
        for file_path in files:
            # Get tags and build output name
            ...
            # Add to treeview
            input_display = file_path.name[:40] + "..." if len(file_path.name) > 40 else file_path.name
            output_display = output_name[:40] + "..." if len(output_name) > 40 else output_name
